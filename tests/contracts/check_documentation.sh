...
for f in README.md HISTORY.md DESIGN.md STORAGE.md TESTING.md CONTRIBUTING.md MAINTAINING.md docs/architecture.md docs/abi.md docs/integration.md docs/qualification.md docs/code-style.md; do test -s "$root/$f" || fail "missing $f"; done
